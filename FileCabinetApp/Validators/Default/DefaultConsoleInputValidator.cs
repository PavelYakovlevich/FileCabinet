...
{
    /// <summary>
    ///     Default console input validator.
    /// </summary>
    public class DefaultConsoleInputValidator : IConsoleInputValidator
    {
        ...
        public Tuple<bool, string> ValidateStature(short stature)
        {
            if (stature < 1)
            {
                return new Tuple<bool, string>(false, $"Stature must be greater than 0");
            }
        ...
        public Tuple<bool, string> ValidateWeight(decimal weight)
        {
            if (weight < 1)
            {
                return new Tuple<bool, string>(false, $"Weight must be greater than 0");
            }
